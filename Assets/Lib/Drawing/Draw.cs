...
namespace UnityLib.Drawing
{
    ...
    public static class Drawing
    {
        ...
        public static void DrawGUILine(Vector2 pointA, Vector2 pointB, Color color, float width, bool antiAlias = true)
        {
            DrawLine(new Vector2(pointA.x, Screen.height - pointA.y), new Vector2(pointB.x, Screen.height - pointB.y), color, width, antiAlias);
        }

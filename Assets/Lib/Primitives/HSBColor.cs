...
namespace UnityLib.Primitives
{
    ...
    public struct HSBColor
    {
        ...
        public static float GetHueDifferent(HSBColor color1, HSBColor color2)
        {
            return Mathf.Abs(color1.h - color2.h);
        }

        public static float GetDifferent(HSBColor color1, HSBColor color2)
        {
            return Mathf.Abs(color1.h - color2.h) + Mathf.Abs(color1.s - color2.s) + Mathf.Abs(color1.b - color2.b);
        }
    }
}
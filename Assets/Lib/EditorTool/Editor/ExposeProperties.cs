...
namespace UnityLib.EditorTool
{
    ...
    {
        public static HashSet<string> excludedTypeName = new HashSet<string>
        {
            "GameObject","CanvasRenderer","Shadow","GraphicRaycaster","AudioListener"
        };

        public static HashSet<string> excludedPropertyName = new HashSet<string> {
        //MonoBehaviour
        "useGUILayout","tag","name","enabled","hideFlags","runInEditMode"
        };
